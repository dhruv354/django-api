...
from companion import  Self_Test_Usage
...
def  self_test_per_user_course(request):
    ...
    practice_session =  Self_Test_Usage(conn, start_date, end_date)
...
def  self_test_time_per_user_course(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def  self_test_per_user_subject(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def  self_test_time_per_user_subject(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def  self_affiliation_analysis(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def  self_daily_test_per_user(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def  self_daily_test_time_per_user(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def  self_weekly_test_per_user(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def  self_weekly_test_time_per_user(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def  self_monthly_test_per_user(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def  self_monthly_test_time_per_user(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def  self_yearly_test_per_user(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def  self_yearly_test_time_per_user(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def  self_quarterly_test_per_user(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def quarterly_self_test(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def  self_quarterly_test_time_per_user(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
