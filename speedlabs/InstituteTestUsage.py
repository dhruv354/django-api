...
from companion import Institute_Test_Usage
...
def institute_test_per_user_course(request):
    ...
    practice_session = Institute_Test_Usage(conn, start_date, end_date)
...
def institute_test_course(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def institute_test_time_per_user_course(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def institute_test_per_user_subject(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def institute_test_subject(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def institute_test_time_per_user_subject(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def institute_affiliation_analysis(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def institute_daily_test_per_user(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def daily_institute_test(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def institute_daily_test_time_per_user(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def institute_weekly_test_per_user(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def weekly_institute_test(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def institute_weekly_test_time_per_user(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def institute_monthly_test_per_user(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def monthly_institute_test(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def institute_monthly_test_time_per_user(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def institute_yearly_test_per_user(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def yearly_institute_test(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def institute_yearly_test_time_per_user(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def institute_quarterly_test_per_user(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def quarterly_institute_test(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
...
def institute_quarterly_test_time_per_user(request):
    returns = request.data['returns']
    try:
        start_date = request.data['data']['start_date']
    except Exception as e:
